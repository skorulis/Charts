...
public class ChartHighlight: NSObject
{
    ...
    /// - parameter x: the y-value of the highlighted value
    ...
    public init(x: Double, y: Double, dataIndex: Int, dataSetIndex: Int, stackIndex: Int, range: ChartRange?)
    {
        super.init()
    ...
    /// - parameter dataSetIndex: the index of the DataSet the highlighted value belongs to
    /// - parameter stackIndex: references which value of a stacked-bar entry has been selected
    public convenience init(x: Double, y: Double, dataIndex: Int, dataSetIndex: Int, stackIndex: Int)
    {
    ...
    /// - parameter stackIndex: references which value of a stacked-bar entry has been selected
    /// - parameter range: the range the selected stack-value is in
    public convenience init(x: Double, y: Double, dataSetIndex: Int, stackIndex: Int, range: ChartRange?)
    {
    ...
    {
        self.init(x: x, y: Double.NaN, dataSetIndex: dataSetIndex, stackIndex: stackIndex, range: nil)
    }
    ...
    {
        self.init(x: x, y: Double.NaN, dataSetIndex: dataSetIndex, stackIndex: -1, range: nil)
    }
